...
The main lesson is that A/B testing is not just about choosing the version with the higher observed conversion rate in one sample. A more careful interpretation asks whether the observed difference is large enough, precise enough, and stable enough to support a real decision. In practice, that means combining statistical evidence with business judgment. Even when CTA B appears to perform better, a good analyst should still ask whether the gain is meaningful in practical terms and whether the experiment was conducted in a way that avoids avoidable mistakes such as premature peeking.